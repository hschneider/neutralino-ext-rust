...
| callback(ext, d)   | A callback function.<br>ext: The extension instance as &mut neutralino::Extension.<br>d: The incoming data-package as &mut serde_json. |
...
| send_message(e, d) | Send a message to Neutralino. <br>e: Event-name as &str.<br> d: Data package as &str or stringified JSON.                              |
