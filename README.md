...
- Add `const BUN = new RustExtension(true)` to your **main.js**
...
...
// Init Bun Extension
const BUN = new RustExtension(true)
```
...
The **RustExtension class** takes only 1 argument which instructs it to run in debug mode (here true). In this mode, all data from the Bun extension is printed to the dev-console:
